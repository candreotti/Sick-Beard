...
SNATCHED_BEST = 13  # episode redownloaded using best quality
...
class StatusStrings:
    ...
    def __getitem__(self, name):
        if name in Quality.DOWNLOADED + Quality.SNATCHED + Quality.SNATCHED_PROPER + Quality.DOWNLOADABLE + Quality.SNATCHED_BEST:
    ...
    def has_key(self, name):
        return name in self.statusStrings or name in Quality.DOWNLOADED or name in Quality.SNATCHED or name in Quality.SNATCHED_PROPER or name in Quality.DOWNLOADABLE or name in Quality.SNATCHED_BEST
