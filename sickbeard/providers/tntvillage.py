...
#                return False
    ...
    def _episodeQuality(self,torrent_rows):
        ...
        if checkName(["(tv|sat|hdtv|hdtvrip|hdtvmux|webdl|webrip|web-dl|web-dlmux|webdlmux|webmux|dlrip|dlmux|dtt|bdmux)","(xvid|h264|divx)"], all) and not checkName(["(720|1080)[pi]"], all):
            return Quality.SDTV
