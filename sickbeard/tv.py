...
from common import DOWNLOADED, SNATCHED, SNATCHED_PROPER, SNATCHED_BEST, ARCHIVED, IGNORED, UNAIRED, WANTED, SKIPPED, DOWNLOADABLE, \
    UNKNOWN, FAILED
    ...
    def deleteShow(self):
        ...
        for cache_file in ek.ek(glob.glob, ek.ek(os.path.join, image_cache_dir, str(self.indexerid) + '.*')):
            ...
            if sickbeard.TRAKT_REMOVE_SHOW_WATCHLIST and sickbeard.USE_TRAKT:
                ...
                if sickbeard.traktWatchListCheckerSchedular.action.update_watchlist("show", "remove", self.indexerid, 0, 0):
