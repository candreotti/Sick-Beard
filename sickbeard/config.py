...
def change_DOWNLOADABLE_SEARCH_FREQUENCY(freq):
    sickbeard.DOWNLOADABLE_SEARCH_FREQUENCY = to_int(freq, default=sickbeard.DEFAULT_DOWNLOADABLE_SEARCH_FREQUENCY)

    if sickbeard.DOWNLOADABLE_SEARCH_FREQUENCY < sickbeard.MIN_DOWNLOADABLE_SEARCH_FREQUENCY:
        sickbeard.DOWNLOADABLE_SEARCH_FREQUENCY = sickbeard.MIN_DOWNLOADABLE_SEARCH_FREQUENCY

    sickbeard.downloadableSearchScheduler.cycleTime = datetime.timedelta(minutes=sickbeard.DOWNLOADABLE_SEARCH_FREQUENCY)
    ...
    def migrate_config(self):
        ...
        if self.config_version > self.expected_config_version:
            logger.log_error_and_exit(u"Your config version (" + str(
                self.config_version) + ") has been incremented past what this version of SickBeard supports (" + str(
                self.expected_config_version) + ").\n" + \
                                      "If you have used other forks or a newer version of SickBeard, your config file may be unusable due to their modifications.")
