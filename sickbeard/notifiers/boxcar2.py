...
class Boxcar2Notifier:
    def test_notify(self, accesstoken, title="SickBeard : Test"):
	...
	#more info goes here - https://boxcar.uservoice.com/knowledgebase/articles/306788-how-to-send-your-boxcar-account-a-notification
        ...
        data = urllib.urlencode({
                ...
                'notification[title]': "SickBeard : " + title + ' : ' + msg,
    ...
    def notify_downloadable(self, ep_name, title=notifyStrings[NOTIFY_DOWNLOADABLE]):
        if sickbeard.BOXCAR2_NOTIFY_ONDOWNLOADABLE:
            self._notifyBoxcar2(title, ep_name)
