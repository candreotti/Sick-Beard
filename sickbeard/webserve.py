...
class ManageSearches(MainHandler):
    def index(self, *args, **kwargs):
        ...
        t.backlogRunning = sickbeard.backlogSearchScheduler.action.amActive  # @UndefinedVariable
        t.downloadableSearchPaused = sickbeard.searchQueueScheduler.action.is_downloadable_search_paused()  # @UndefinedVariable
    ...
    def forceDownloadableSearch(self, *args, **kwargs):
        # force it to run the next time it looks
        result = sickbeard.downloadableSearchScheduler.forceRun()
        if result:
            logger.log(u"Downloadable Search forced")
            ui.notifications.message('Downloadable Search started')
    ...
    def pauseDownloadableSearch(self, paused=None):
        if paused == "1":
            sickbeard.searchQueueScheduler.action.pause_downloadableSearch()  # @UndefinedVariable
        else:
            sickbeard.searchQueueScheduler.action.unpause_downloadableSearch()  # @UndefinedVariable
...
class ConfigSearch(MainHandler):
    ...
    def saveSearch(self, use_nzbs=None, use_torrents=None, nzb_dir=None, sab_username=None, sab_password=None,
                   ...
                   nzbget_host=None, nzbget_use_https=None, backlog_days=None, backlog_frequency=None, downloadable_search_days=None, downloadable_search_frequency=None,
        ...
        config.change_DOWNLOADABLE_SEARCH_FREQUENCY(downloadable_search_frequency)
        sickbeard.BACKLOG_DAYS = config.to_int(backlog_days, default=7)
        sickbeard.DOWNLOADABLE_SEARCH_DAYS = config.to_int(downloadable_search_days, default=7)
        ...
        sickbeard.DOWNLOADABLE_SEARCH_STARTUP = config.checkbox_to_value(downloadable_search_startup)
...
class ConfigNotifications(MainHandler):
    ...
    def saveNotifications(self, use_xbmc=None, xbmc_always_on=None, xbmc_notify_onsnatch=None,
                          xbmc_notify_ondownload=None, xbmc_notify_ondownloadable=None,
                          ...
                          xbmc_password=None,
                          use_plex=None, plex_notify_onsnatch=None, plex_notify_ondownload=None, plex_notify_ondownloadable=None,
                          plex_notify_onsubtitledownload=None, plex_update_library=None,
                          plex_server_host=None, plex_host=None, plex_username=None, plex_password=None,
                          use_growl=None, growl_notify_onsnatch=None, growl_notify_ondownload=None, growl_notify_ondownloadable=None,
                          growl_notify_onsubtitledownload=None, growl_host=None, growl_password=None,
                          use_prowl=None, prowl_notify_onsnatch=None, prowl_notify_ondownload=None, prowl_notify_ondownloadable=None,
                          prowl_notify_onsubtitledownload=None, prowl_api=None, prowl_priority=0,
                          use_twitter=None, twitter_notify_onsnatch=None, twitter_notify_ondownload=None, twitter_notify_ondownloadable=None,
                          twitter_notify_onsubtitledownload=None,
                          use_boxcar=None, boxcar_notify_onsnatch=None, boxcar_notify_ondownload=None, boxcar_notify_ondownloadable=None,
                          boxcar_notify_onsubtitledownload=None, boxcar_username=None,
                          use_boxcar2=None, boxcar2_notify_onsnatch=None, boxcar2_notify_ondownload=None, boxcar2_notify_ondownloadable=None,
                          boxcar2_notify_onsubtitledownload=None, boxcar2_accesstoken=None,
                          use_pushover=None, pushover_notify_onsnatch=None, pushover_notify_ondownload=None,  pushover_notify_ondownloadable=None,
                          pushover_notify_onsubtitledownload=None, pushover_userkey=None, pushover_apikey=None,
                          use_libnotify=None, libnotify_notify_onsnatch=None, libnotify_notify_ondownload=None, libnotify_notify_ondownloadable=None,
                          ...
                          use_nma=None, nma_notify_onsnatch=None, nma_notify_ondownload=None, nma_notify_ondownloadable=None,
                          nma_notify_onsubtitledownload=None, nma_api=None, nma_priority=0,
                          use_pushalot=None, pushalot_notify_onsnatch=None, pushalot_notify_ondownload=None, pushalot_notify_ondownloadable=None,
                          pushalot_notify_onsubtitledownload=None, pushalot_authorizationtoken=None,
                          use_pushbullet=None, pushbullet_notify_onsnatch=None, pushbullet_notify_ondownload=None, pushbullet_notify_ondownloadable=None,
                          pushbullet_notify_onsubtitledownload=None, pushbullet_api=None, pushbullet_device=None,
                          pushbullet_device_list=None,
                          use_email=None, email_notify_onsnatch=None, email_notify_ondownload=None, email_notify_ondownloadable=None,
        ...
        sickbeard.BOXCAR2_NOTIFY_ONDOWNLOADABLE = config.checkbox_to_value(boxcar2_notify_ondownloadable)
        ...
        sickbeard.TRAKT_REMOVE_SHOW_WATCHLIST = config.checkbox_to_value(trakt_remove_show_watchlist)
        ...
        sickbeard.PUSHBULLET_NOTIFY_ONDOWNLOADABLE = config.checkbox_to_value(pushbullet_notify_ondownloadable)
...
class NewHomeAddShows(MainHandler):
    ...
    def searchIndexersForShowName(self, search_term, lang="it", indexer=None):
...
class Home(MainHandler):
            ...
            if not sickbeard.showQueueScheduler.action.isBeingUpdated(showObj):  # @UndefinedVariable
                t.submenu.append(
                    {'title': 'Delete', 'path': 'home/deleteShow?show=%d&amp;full=1' % showObj.indexerid,
                     'confirm': True})
                t.submenu.append(
                    {'title': 'Remove', 'path': 'home/deleteShow?show=%d' % showObj.indexerid, 'confirm': False})
            ...
            if os.path.normpath(showObj._location) != os.path.normpath(location):
                ...
                # don't bother if we're going to update anyway
                    ...
                    try:
                        ...
                        errors.append(
                            "The folder at <tt>%s</tt> doesn't contain a tvshow.nfo - copy your files to that folder before you change the directory in SickBeard." % location)
    ...
    def setStatus(self, show=None, eps=None, status=None, direct=False):
        ...
        if int(status) == SKIPPED:           
            if sickbeard.traktCheckerScheduler.action.refreshEpisodeWatchlist():
                sickbeard.traktCheckerScheduler.action.removeEpisodeFromWatchList()
